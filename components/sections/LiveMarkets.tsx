...
const marketsAndIntegrations = [
	{
		...
		description:
			'Fixed-maturity lending venue for predictable USDU borrowing.',
			...
			<div className="container mx-auto px-4">
				<motion.div
					...
					<p className="text-xl text-text-secondary max-w-3xl mx-auto">
						USDU is actively deployed across supervised lending and
						liquidity venues, with access governed by DAO risk
						curation and approved collateral frameworks.
					</p>
				</motion.div>
